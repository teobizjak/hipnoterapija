  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
        <a href="#" className="text-2xl font-serif font-bold text-lime-600 tracking-wide inline-flex">
          <img src={logo} alt="Notranja Preobrazba" className="h-12 w-auto object-contain" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="bg-gradient-to-br from-lime-50/80 via-white to-rose-50/50 border border-lime-200/50 rounded-2xl p-6 md:p-8 relative overflow-hidden">
              ...
              <p className="text-center text-stone-700 font-serif text-lg font-semibold mb-5">
                Kaj lahko pričakujete
              </p>

              <ul className="flex flex-col gap-3">
                {[
                  { icon: 'fa-shield-heart', text: 'Varen prostor brez obsojanja' },
                  { icon: 'fa-fingerprint', text: 'Individualen pristop' },
                  { icon: 'fa-lock', text: 'Popolna zaupnost' },
                  { icon: 'fa-feather', text: 'Nežno, a učinkovito delo' },
                  { icon: 'fa-hand-holding-heart', text: 'Podpora tudi med srečanji' },
                ].map((item, i) => (
                  <li key={i} className="flex items-center gap-3 bg-white border border-lime-200/60 rounded-xl px-4 py-3 shadow-sm shadow-lime-100/40 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                    <div className="flex-shrink-0 w-9 h-9 rounded-full bg-gradient-to-br from-lime-400 to-lime-500 flex items-center justify-center shadow-md shadow-lime-300/30">
    ...
    <footer className="bg-stone-800 text-stone-400 py-12">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <div className="flex justify-center mb-3">
          <img src={logo} alt="Notranja Preobrazba" className="h-16 w-auto object-contain opacity-90 brightness-0 invert" />
        </div>
